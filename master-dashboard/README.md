...
This branch contains the implementation for **SolarChick** and **GyuGalaxy** distributed cloud nodes.
...
4.  **Environment Variables**: Create a `.env` file in the root directory with the following keys:
    - `SUPABASE_URL_A` (For SolarChicken)
    - `SUPABASE_KEY_A`
    - `SUPABASE_URL_B` (For GyuGalaxy)
    - `SUPABASE_KEY_B`
